...
<div class="card mb-4 py-3 border-left-secondary " style="max-width: 540px;">
	<div class="card-body">
		<div>
			<a href="<?php echo base_url("dosen/profil/editprofil") ?>" class="small-box-footer">Edit Profil <i class="fas fa-arrow-circle-right"></i></a>
		</div>
	</div>
</div>
...
<div class="card mb-4 py-3 border-left-secondary" style="max-width: 540px;">
	<div class="card-body">
		<div>
			<a href="<?php echo base_url("dosen/changepassword") ?>" class="small-box-footer">Ganti Password <i class="fas fa-arrow-circle-right"></i></a>
		</div>
	</div>
</div>
